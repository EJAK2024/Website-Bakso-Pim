...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <section class="flex-1 py-10">
        <div class="container mx-auto px-4 max-w-lg">
            ...
            <form method="POST" action="{{ route('menu.update', $menu) }}" class="bg-white rounded-xl shadow-lg p-8">
                @csrf
                @method('PUT')
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="image" id="image" value="{{ old('image', $menu->image) }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition">
                </div>
