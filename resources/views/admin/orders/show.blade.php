...
<head>
    ...
    <title>Detail Pesanan #{{ $order->id }} - Bakso Pim</title>
...
<body class="bg-gray-50 min-h-screen flex flex-col">
    <nav class="bg-green-800 text-white py-4 shadow-lg">
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('orders.index') }}" class="font-medium text-green-100 hover:text-white transition-all duration-150 active:scale-95">
    ...
    <section class="flex-1 py-10">
        <div class="container mx-auto px-4 max-w-2xl">
            <h1 class="text-3xl font-bold text-green-700 mb-2">Detail Pesanan #{{ $order->id }}</h1>
