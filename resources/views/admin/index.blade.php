        ...
        <div class="container mx-auto px-4">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-700 mt-1">4</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-amber-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-amber-600 mt-1">4</p>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all duration-150 active:scale-[1.02]">
                        <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center mr-4">
                            <i class="fas fa-edit text-green-600"></i>
                        </div>
                        <div>
                            <p class="font-semibold text-gray-800">Kelola Menu</p>
                            <p class="text-sm text-gray-500">Tambah / ubah / hapus menu makanan & minuman</p>
                        </div>
                    </a>
                    <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all duration-150 active:scale-[1.02]">
                        <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center mr-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Pantau pesanan masuk dari pelanggan</p>
                        </div>
                    </a>
                    <a href="/register" class="flex items-center p-4 border border-gray-200 rounded-lg hover:border-green-500 hover:bg-green-50 transition-all duration-150 active:scale-[1.02]">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Buat akun admin baru untuk kelola website</p>
                        </div>
                    </a>
                </div>
            </div>
